  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#FAF8F5]">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <p className="text-[#D4AF37] text-xs font-semibold tracking-widest uppercase mb-4 flex items-center gap-2">
                  <span className="w-5 h-[1px] bg-[#D4AF37]" /> Your Journey
                </p>
              ...
              <div className="relative">
                ...
                {/* Floating stat card */}
                <div className="absolute -bottom-5 -left-5 bg-[#2C1810] text-white px-6 py-4 rounded-2xl shadow-xl border border-[#D4AF37]/30">
        ...
        <section className="py-20 bg-[#FAF8F5]">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="text-center mb-14">
              <p className="text-[#D4AF37] text-xs font-semibold tracking-widest uppercase mb-3">Step by Step</p>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-[#2C1810]">The Home Buying Process</h2>
            </div>
        ...
        {/* ── MORTGAGE CALCULATOR ── */}
        <section id="mortgage-calculator" className="py-20 bg-[#2C1810] relative overflow-hidden">
          {/* bg image */}
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="lg:pt-4">
                <p className="text-[#D4AF37] text-xs font-semibold tracking-widest uppercase mb-4 flex items-center gap-2">
                  <span className="w-5 h-[1px] bg-[#D4AF37]" /> Plan Your Budget
                </p>
                ...
                <div className="mb-2">
                  <label htmlFor="home-price" className="block text-white/80 text-sm font-medium mb-2">
                    <span className="flex items-center gap-2"><DollarSign className="w-4 h-4 text-[#D4AF37]" /> Home Price (CAD)</span>
                  </label>
                  <input
                    id="home-price"
                    type="number"
                    ...
                    className="w-full px-5 py-3.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] text-base backdrop-blur"
                    placeholder="800,000"
                  />
                  ...
                  {[{ v: "500000", l: "$500K" }, { v: "800000", l: "$800K" }, { v: "1200000", l: "$1.2M" }].map((p) => (
                    <button
                      ...
                      className={`py-2 rounded-lg text-sm font-semibold border transition-colors ${
                        priceInput === p.v
                          ? "bg-[#D4AF37] border-[#D4AF37] text-[#2C1810]"
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="text-center mb-12">
              <p className="text-[#D4AF37] text-xs font-semibold tracking-widest uppercase mb-3">Be Prepared</p>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-[#2C1810]">Key Costs to Budget For</h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
              {COSTS.map((item, i) => (
                <div key={i} className="flex items-start gap-4 p-5 bg-[#FAF8F5] rounded-2xl border border-[#E8D5C0]">
                  <div className="w-2 h-2 rounded-full bg-[#D4AF37] mt-2 shrink-0" />
                  <div>
                    <h3 className="font-semibold text-[#2C1810] mb-1">{item.title}</h3>
                    <p className="text-[#2C1810] font-bold text-lg">{item.amount}</p>
        ...
        <section className="py-20 bg-[#FAF8F5]">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="text-center mb-12">
              <p className="text-[#D4AF37] text-xs font-semibold tracking-widest uppercase mb-3">Tools & Guides</p>
              <h2 className="font-display text-3xl font-bold text-[#2C1810]">Helpful Resources</h2>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {RESOURCES.map((resource, i) => (
                <a
                  key={i}
                  href="#"
                  className="group p-5 bg-white rounded-2xl border border-[#E8D5C0] hover:border-[#D4AF37] hover:shadow-lg transition-all"
                >
                  <div className="w-8 h-8 bg-[#2C1810] rounded-lg flex items-center justify-center mb-3 group-hover:bg-[#D4AF37] transition-colors">
                    <Calculator className="w-4 h-4 text-white" />
                  </div>
                  <h3 className="font-semibold text-[#2C1810] text-sm mb-1">{resource.title}</h3>
          ...
          <div className="absolute inset-0 bg-[#2C1810]/90 flex items-center justify-center">
            <div className="text-center px-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/listings" className="px-8 py-3.5 bg-[#D4AF37] text-[#2C1810] font-bold rounded-xl hover:bg-[#C9A227] transition-colors shadow-lg">
                  Browse Listings
                </Link>
                <Link href="/contact" className="px-8 py-3.5 border-2 border-white/30 text-white font-semibold rounded-xl hover:border-[#D4AF37] hover:text-[#D4AF37] transition-colors">
                  Talk to an Agent
                </Link>
              </div>
            </div>
